...
def calcNDVI(image_file, output_file):
    # Formula source: https://wiki.orfeo-toolbox.org/index.php/Radiometric_Indices after Tucker (1999)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 2:
        ...
        print ("Number of must be ", len(sys.argv))
        print('1. argument: Name of the python script')
        print('2. argument: Raster image filename')
        exit()
